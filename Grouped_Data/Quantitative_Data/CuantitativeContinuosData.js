...
****************************************************************************************************** */
function clases_groped(dataArray, numClass = null) {
...
const freqAbs = function (limsLow, limsUpp, dataArray, way) {
    let fa = new Array(limsLow.length).fill(0);
...
const freqRel = function (freqAbs) {
    let freqRel = [];
...
const generateContinousCuantitativeData = function (dataArray, way, numClasses = null) {
    if (numClasses == '') {
        numClasses = null;
    }
    else {
